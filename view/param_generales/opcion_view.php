...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Parámetros Generales - Opciones</title>
						...
						<div class="row">
							<div class="col-md-12">								
								<div class="table-header">
									Lista de Opciones &nbsp;&nbsp;
									<a  href="#modalOpciones" id="new_opcion" data-toggle='modal' onclick="nuevo();" class='white'>
			                            <i class='ace-icon fa fa-plus-circle bigger-150'></i>
			                        </a>
								</div>
								<div>
									<table id="tablaOpciones" class="table table-striped table-bordered">
										<thead>											
								            <tr>
								                <th style="text-align: center; font-size: 11px; height: 10px; width: 5%;">N°</th>
								                <th style="text-align: center; font-size: 11px; height: 10px; width: 13%;">GRUPO</th>
								                <th style="text-align: center; font-size: 11px; height: 10px; width: 14%;">OPCION</th>
								                <th style="text-align: center; font-size: 11px; height: 10px; width: 23%;">DESCRIPCION</th>
								                <th style="text-align: center; font-size: 11px; height: 10px; width: 7%;">ORDEN</th>
								                <th style="text-align: center; font-size: 11px; height: 10px; width: 15%;">URL</th>
										...
										<tbody id="cuerpoOpciones">																	
										</tbody>
									</table>
								</div>
							</div>				
							<input type="hidden" dissabled="true" value="Parámetros" id="NombreGrupo">
                            <input type="hidden" dissabled="true" value="Opciones" id="NombreTarea">			
					...
					<div class="modal-dialog" style="width: 40% !important;">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h3 class="blue bigger">DATOS DE LA OPCIÓN</h3>
							</div>
							<form  method="POST" id="form_opcion">
										...
										<div class="modal-body col-md-12">
											...
											<div style="display:none;" class="form-group col-md-4">												
												<div class="input-group">													
													<input type="text" class='col-md-12' name="param_tareaId" id="param_tareaId">
												</div>
											</div>

											<div class="form-group col-md-12">
												<label for="param_opcionGrupo">Grupo</label>
												<div id="grupo">
													<div class="input-group col-md-12">														
														<select class="form-control" id="param_opcionGrupo" name="param_opcionGrupo">
															<option value="" disabled selected style="display: none;">Seleccionar Grupo</option>
														</select>
													</div>
												</div>
											</div>
											...
											<div class="form-group col-md-12">
												<label for="param_tarea">Opción</label>
												<div class="input-group col-md-12">													
													<input class="col-md-12" type="text"  name="param_tarea" id="param_tarea"/>
												</div>
											</div>											

											<div class="form-group col-md-12">
												<label for="param_tareaDescripcion">Descripción</label>
												<div class="input-group col-md-12">													
													<input class="col-md-12" type="text"  name="param_tareaDescripcion" id="param_tareaDescripcion"/>
												</div>
											</div>

											<div class="form-group col-md-3">
												<label for="param_tareaOrden">Orden</label>
												<div class="input-group col-md-12">													
													<input class="col-md-12" type="text" name="param_tareaOrden" id="param_tareaOrden" onkeypress="return solonumeros(event)"/>
												</div>
											</div>

											<div class="form-group col-md-12">
												<label for="param_tareaUrl">URL</label>
												<div class="input-group col-md-12">													
													<input class="col-md-12" type="text" name="param_tareaUrl" id="param_tareaUrl"/>
												</div>
											</div>											
										</div>																											
									</div>
		                        ...
		                        <div class="modal-footer">
									...
									<input style="display:none;" type="button" id="guardarOpcion" class="btn btn-sm btn-primary" onclick="guardar();" value="Guardar"/>
									<input style="display:none;" type="button" id="editarOpcion" class="btn btn-sm btn-primary" onclick="editar();" value="Modificar"/>
								</div>
							</form>
						</div>
					</div>
...
<![endif]-->
		...
		<script src="../default/js/opciones.js"></script>	
