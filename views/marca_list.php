									...
									<div class="widget-body" id="info_personal">
										<div class="panel panel-primary" style="border:0">
				                            ...
				                            <div class="panel-body col-md-offset-2">
				                                <a href="#modal-form" role="button" data-toggle="modal" id="nuevaMarca" class="btn btn-info btn-lg">NUEVO</a>
				                                </div>                            
				                            <div class="panel-body">
				                                <div class="table-responsive col-md-8 col-md-offset-2">
			                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
			                                            <thead>
			                                                <tr>            
			                                                  <th style='text-align: center;' class="col-xs-3">CÓDIGO</th>                                    		                                                  
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h3 class="blue bigger">REGISTRO DE NUEVA MARCA</h3>
											</div>
											<form  method="POST" id="form_registro_marca">													
												<div class="modal-body">
													<div class="row">
														<form id="form_registro_marca" method="POST">
																<div class="modal-body">
																	<div class="form-group col-md-8 col-md-offset-2">
																		<label for="param_marcaDescripcion">Marca</label>
																		<div class="input-group">
																			<span class="input-group-addon">
																				<i class="ace-icon fa fa-barcode"></i>
																			</span>
																			<input class="col-md-12" type="text" name="param_marcaDescripcion" id="param_marcaDescripcion" placeholder="Ingrese la Marca" />
																		</div>
																	</div>																
																</div>																											
													</div>
												...
												<div class="modal-footer">													
													...
													<input type="button" id="registroMarca" class="btn btn-sm btn-primary" value="Guardar"/>
												</div>
											</form>
										</div>
									</div>
...
<![endif]-->
    	...
    	<script src="default/js/marca.js"></script>		
