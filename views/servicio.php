									...
									<div class="widget-body" id="info_personal">
										<div class="panel panel-primary" style="border:0">
				                            <div class="panel-heading">	
				                            	<h2>SERVICIOS REGISTRADAS</h2>
				                            </div>
				                            <div class="panel-body">
				                                <a href="#modal-form" role="button" data-toggle="modal" id="nuevoServicio" class="btn btn-info btn-lg">NUEVO</a>
				                                </div>                            
				                            <div class="panel-body">
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h3 class="blue bigger">REGISTRO DE NUEVO SERVICIO</h3>
											</div>
											<form id='form_registro_servicio' method="POST">													
												<div class="modal-body">
													<div class="row">
														<form action="" method="POST">
																<div class="modal-body col-md-offset-1">
																	<div class="form-group">
																		<label for="param_servCodigo">Código</label>
																		<div class="input-group col-md-4">
																			<span class="input-group-addon">
																				<i class="ace-icon fa fa-barcode"></i>
																			</span>
																			<input type="text" name="param_servCodigo" id="param_servCodigo" placeholder="Código del servicio" >
																		</div>
																	</div>
																	<div class="form-group ">
																		<label for="param_personSucursal">Sucursal</label>
																		<div id="sucursal">
																			
																		</div>
																	</div>																
																	<div class="form-group ">
																		<label for="param_servDescripcion">Servicio</label>
																		<div class="input-group">
																			<span class="input-group-addon">
																				<i class="ace-icon fa fa-scissors"></i>
																			</span>
																			<input type="text" class="col-md-10" name="param_servDescripcion" id="param_servDescripcion" placeholder="Ingrese el servicio">
																		</div>
																	</div>	
																	<div class="form-group">
																		<label for="param_servPrecioBase">Precio Base</label>
																		<div class="input-group">
																			<span class="input-group-addon">
																				<i class="ace-icon fa fa-dollar"></i>
																			</span>
																			<input type="text" class='col-md-3' name="param_servPrecioBase" id="param_servPrecioBase" placeholder="S/." >
																		</div>
																	</div>
																</div>	
													</div>
												...
												<div class="modal-footer">													
													...
													<input type="button" id="registroServicio" class="btn btn-sm btn-primary" value="Guardar"/>
												</div>
											</form>
										</div>
									</div>
...
<![endif]-->
    	...
    	<script src="default/js/servicio.js"></script>		
