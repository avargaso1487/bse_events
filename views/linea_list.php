									...
									<div class="widget-body" id="info_personal">
										<div class="panel panel-primary" style="border:0">
				                            ...
				                            <div class="panel-body col-md-offset-2">
				                                <a href="#modal-form" role="button" data-toggle="modal" id="nuevaLinea" class="btn btn-info btn-lg">NUEVO</a>
				                                </div>                            
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h3 class="blue bigger">REGISTRO DE NUEVA LÍNEA</h3>
											</div>
											<form  method="POST" id="form_registro_linea">													
												<div class="modal-body">
													<div class="row">
														<div class="modal-body">
															<div class="form-group col-md-8 col-md-offset-2">
																<label for="param_lineaDescripcion">Línea</label>
																<div class="input-group">
																	<span class="input-group-addon">
																		<i class="ace-icon fa fa-barcode"></i>
																	</span>
																	<input class="col-md-12" type="text" name="param_lineaDescripcion" id="param_lineaDescripcion" placeholder="Ingrese la Línea" />
																</div>
															</div>																
														</div>																											
													</div>
												...
												<div class="modal-footer">																										
													...
													<input type="button" id="registroLinea" class="btn btn-sm btn-primary" value="Guardar"/>
												</div>
											</form>
										</div>
									</div>
...
<![endif]-->
    	...
    	<script src="default/js/linea.js"></script>		
