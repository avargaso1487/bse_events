...
<head>
	...
	<script src="default/js/personal_list.js"></script>	
	</head>
			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>Personal</li>
							<li class="active">Lista de Colaboradores</li>
						</ul><!-- /.breadcrumb -->
										...
										<div class="panel panel-primary" style="border:0">
				                            ...
				                            <div>				                               
		                                        <table class="table table-striped table-bordered" id="example">
		                                            <thead>
		                                                <tr>            
		                                                  <th style="text-align: center; font-size: 13px; height: 10px; width: 10%;">CÓDIGO</th>                                    
		                                                  <th style="text-align: center; font-size: 13px; height: 10px; width: 15%;">SUCURSAL</th>
		                                                  <th style="text-align: center; font-size: 13px; height: 10px; width: 15%;">NOMBRES</th>                                                  
		                                                  <th style="text-align: center; font-size: 13px; height: 10px; width: 10%;">CORREO</th>
		                                                  <th style="text-align: center; font-size: 13px; height: 10px; width: 10%;">TELEFONO</th>
		                                                  <th style="text-align: center; font-size: 13px; height: 10px; width: 8%;">FECHA DE INGRESO</th>
		                                                  <th style="text-align: center; font-size: 13px; height: 10px; width: 7%;">ESTADO</th>			                                                  
		                                                  <th style="text-align: center; font-size: 13px; height: 10px; width: 10%;">OPERACIONES</th>			                                                  
		                                                </tr>
		                                            </thead>           
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h3 class="blue bigger">DATOS DEL PERSONAL</h3>
							</div>
							<form  method="POST" id="form_edit_personal">													
								<div class="modal-body">
									<div class="row">
										<div class="modal-body">
											<div style="display:none;" class="form-group col-md-4">
												<label for="param_personalCodigo">Código</label>
												<div class="input-group">
													<span class="input-group-addon">
														<i class="ace-icon fa fa-barcode"></i>
													</span>
													<input class="col-md-12" type="text"  name="param_personalCodigo" id="param_personalCodigo"/>
												</div>
											</div>
											
											<div class="form-group col-md-5">
												<label for="param_personalDNI">DNI</label>
												<div class="input-group">
													<span class="input-group-addon">
														<i class="ace-icon fa fa-building"></i>
													</span>
													<input class="input-mask-dni col-md-12" type="text"  name="param_personalDNI"  id="param_personalDNI"/>
												</div>
											</div>
											<div class="form-group col-md-7">
												<label for="param_personalNombres">Nombres</label>
												<div class="input-group">
													<span class="input-group-addon">
														<i class="ace-icon fa fa-building"></i>
													</span>
													<input class="col-md-12" type="text"  name="param_personalNombres" id="param_personalNombres"/>
												</div>
											</div>

											<div class="form-group col-md-5">
												<label for="param_personalApellidoPaterno">Apellido Paterno</label>
												<div class="input-group">
													<span class="input-group-addon">
														<i class="ace-icon fa fa-building"></i>
													</span>
													<input class="col-md-12" type="text"  name="param_personalApellidoPaterno" id="param_personalApellidoPaterno"/>
												</div>
											</div>

											<div class="form-group col-md-5">
												<label for="param_personalApellidoMaterno">Apellido Materno</label>
												<div class="input-group">
													<span class="input-group-addon">
														<i class="ace-icon fa fa-building"></i>
													</span>
													<input class="col-md-12" type="text"  name="param_personalApellidoMaterno" id="param_personalApellidoMaterno"/>
												</div>
											</div>

											<div class="form-group col-md-12">
												<label for="param_personSucursal">Sucursal de trabajo</label>
												<div id="sucursal">
											...
											<div class="form-group col-md-12">
												<label for="param_personalDireccion">Dirección</label>
												<div class="input-group">
													<span class="input-group-addon">
														<i class="ace-icon fa fa-building"></i>
													</span>
													<input class="col-md-12" type="text"  name="param_personalDireccion" id="param_personalDireccion"/>
												</div>
											</div>

											<div class="form-group col-md-4">
												<label for="param_personalTelefonoFijo">Teléfono Fijo</label>
												<div class="input-group">
													<span class="input-group-addon">
														<i class="ace-icon fa fa-mobile"></i>
													</span>
													<input class="input-mask-phone col-md-12" type="text"  name="param_personalTelefonoFijo" id="param_personalTelefonoFijo"/>
												</div>
											</div>
											
											<div class="form-group col-md-4">
												<label for="param_personalTelefonoCelular">Teléfono Celular</label>
												<div class="input-group">
													<span class="input-group-addon">
														<i class="ace-icon fa fa-mobile"></i>
													</span>
													<input class="input-mask-phone col-md-12" type="text"  name="param_personalTelefonoCelular" id="param_personalTelefonoCelular"/>
												</div>
											</div>

											<div class="form-group col-md-12">
												<label for="param_personalCorreo">Correo</label>
												<div class="input-group">
													<span class="input-group-addon">
														<i class="ace-icon fa fa-envelope"></i>
													</span>
													<input class="col-md-12" type="text"  name="param_personalCorreo" id="param_personalCorreo"/>
												</div>
											</div>

											<div class="form-group col-md-4">
												<label for="param_personalNacimiento">Fecha Nacimiento</label>
												<div class="input-group">
													<span class="input-group-addon">
														<i class="ace-icon fa fa-calendar"></i>
													</span>
													<input class="input-mask-date col-md-12" type="text"  name="param_personalNacimiento" id="param_personalNacimiento"/>
												</div>
											</div>
											<div class="form-group col-md-8">
												<label for="param_personalLugarNacimiento">Lugar Nacimiento</label>
												<div class="input-group">
													<span class="input-group-addon">
														<i class="ace-icon fa fa-building"></i>
													</span>
													<input class="col-md-12" type="text"  name="param_personalLugarNacimiento" id="param_personalLugarNacimiento"/>
												</div>
											</div>

											<div class="form-group col-md-4">
												<label for="param_personalIngreso">Fecha Ingreso</label>
												<div class="input-group">
													<span class="input-group-addon">
														<i class="ace-icon fa fa-calendar"></i>
													</span>
													<input class="input-mask-date col-md-12" type="text"  name="param_personalIngreso" id="param_personalIngreso"/>
												</div>
											</div>
											<div class="form-group col-md-4">
												<label for="param_personalEstado">Estado Actual</label>
												<div class="input-group">
													<span class="input-group-addon">
														<i class="ace-icon fa fa-user"></i>
													</span>
													<input class="col-md-12" type="text"  name="param_personalEstado" id="param_personalEstado"/>
												</div>
											</div>
								...
								<div class="modal-footer">
									...
									<input style="display:none;" type="button" id="editarPersonal" class="btn btn-sm btn-primary" value="Modificar"/>
